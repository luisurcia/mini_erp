...
- **Modo comparación** (toggle "Comparar", requiere 2+ años):
  ...
  - Los gráficos "por mes" pasan a **una serie por año**; el gráfico por producto pasa a **barras agrupadas de "Total de ventas por producto"** (monto neto, producto × periodo — este sí sigue siendo por monto, coloreado por periodo en vez de por producto); la torta se **oculta**.
...
*Scoby ERP — PRD por ingeniería inversa · rama `client/scoby` · commit `bb4d062` · 10 septiembre 2026*
