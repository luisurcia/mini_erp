...
- **Migración de datos reales — ventas cargadas, inventario pendiente ([#121](https://github.com/luisurcia/mini_erp/issues/121)):** el 10 de septiembre 2026 se reseteó producción (`flask reset-data`, quedando solo usuarios y configuración) y se cargaron las **1.026 ventas reales** de Scoby (junio 2025 → septiembre 2026) vía `flask import-ventas`: ~$47,4M, 28.732 botellas, 295 clientes (todos en el segmento "Otros"), 497 facturas, 970 pagadas / 56 por pagar. El catálogo quedó reducido a los **8 productos reales** de la planilla de origen. La planilla **no traía stock**, así que el **inventario quedó en 0** — **el equipo no puede registrar ventas nuevas hasta cargar el conteo real de existencias** (issue #119, pendiente). Falta además conciliar los totales cargados contra el Excel de Scoby (#120) y revisar las ventas de la ventana de transición (9→10 de septiembre).
...
- **Bodega de Fermentación en producción:** la que el equipo había creado a mano ("En Fermentación") se renombró a **"Bodega de Fermentación"** y quedó con su rol de flujo; conviene confirmar en `Configuración → Bodegas` que el stock que tuviera se conservó (aunque, ver arriba, el reseteo de la migración dejó todo el inventario en 0 de todas formas).
